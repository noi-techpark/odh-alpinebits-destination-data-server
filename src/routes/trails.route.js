...
module.exports = function (app) {
  ...
  app.get("/2.0/trails", function (req, res) {
    try {
      connector
        .getTrails(parseCollectionRequest(req))
        .then((data) => res.json(data))
  ...
  app.get("/2.0/trails/:id", function (req, res) {
    try {
      connector
        .getTrailById(parseResourceRequest(req))
        .then((data) => res.json(data))
  ...
  app.get("/2.0/trails/:id/categories", function (req, res) {
    errors.handleNotImplemented(req, res);
  });

  app.get("/2.0/trails/:id/connections", function (req, res) {
    errors.handleNotImplemented(req, res);
  });

  app.get("/2.0/trails/:id/features", function (req, res) {
    errors.handleNotImplemented(req, res);
  });

  app.get("/2.0/trails/:id/multimediaDescriptions", function (req, res) {
    try {
      connector
        .getTrailMedia(parseResourceRequest(req))
        .then((data) => res.json(data))
