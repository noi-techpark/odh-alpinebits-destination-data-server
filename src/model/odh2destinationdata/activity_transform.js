...
function transformToSkiSlope(odhItem, request) {
    ...
    // TODO: update categories relationship
    // skiSlope.relationships.categories = transformMultimediaDescriptions(skiSlope, activity, request);
...
function transformToSnowpark(odhItem, request) {
    ...
    // TODO: update categories relationship
    // snowpark.relationships.categories = transformMultimediaDescriptions(snowpark, activity, request);
