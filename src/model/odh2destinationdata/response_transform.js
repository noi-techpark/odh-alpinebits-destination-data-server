...
const { CollectionResponse: DestinationDataCollection, ObjectResponse: DestinationDataObject } = require('../destinationdata/collection');
...
module.exports = {
    ...
    transformToEventCategories: (odhItem, request) => transformRelationshipToMany(odhItem, request, transformToEvent, 'categories'),
    transformToEventContributors: (odhItem, request) => transformRelationshipToMany(odhItem, request, transformToEvent, 'contributors'),
    transformToEventEventSeries: (odhItem, request) => transformRelationshipToOne(odhItem, request, transformToEvent, 'series'),
    transformToEventMultimediaDescriptions: (odhItem, request) => transformRelationshipToMany(odhItem, request, transformToEvent, 'multimediaDescriptions'),
    transformToEventOrganizers: (odhItem, request) => transformRelationshipToMany(odhItem, request, transformToEvent, 'organizers'),
    transformToEventPublisher: (odhItem, request) => transformRelationshipToOne(odhItem, request, transformToEvent, 'publisher'),
    transformToEventSponsors: (odhItem, request) => transformRelationshipToMany(odhItem, request, transformToEvent, 'sponsors'),
    transformToEventSubEvents: (odhItem, request) => transformRelationshipToMany(odhItem, request, transformToEvent, 'subEvents'),
    transformToEventVenues: (odhItem, request) => transformRelationshipToMany(odhItem, request, transformToEvent, 'venues'),
    ...
    transformToLiftCategories: (odhItem, request) => transformRelationshipToMany(odhItem, request, transformToLift, 'categories'),
    transformToLiftConnections: (odhItem, request) => transformRelationshipToMany(odhItem, request, transformToLift, 'connections'),
    transformToLiftMultimediaDescriptions: (odhItem, request) => transformRelationshipToMany(odhItem, request, transformToLift, 'multimediaDescriptions'),
    ...
    transformToSkiSlopeCategories: (odhItem, request) => transformRelationshipToMany(odhItem, request, transformToSkiSlope, 'categories'),
    transformToSkiSlopeConnections: (odhItem, request) => transformRelationshipToMany(odhItem, request, transformToSkiSlope, 'connections'),
    transformToSkiSlopeMultimediaDescriptions: (odhItem, request) => transformRelationshipToMany(odhItem, request, transformToSkiSlope, 'multimediaDescriptions'),
    ...
    transformToSnowparkCategories: (odhItem, request) => transformRelationshipToMany(odhItem, request, transformToSnowpark, 'categories'),
    transformToSnowparkConnections: (odhItem, request) => transformRelationshipToMany(odhItem, request, transformToSnowpark, 'connections'),
    transformToSnowparkFeatures: (odhItem, request) => transformRelationshipToMany(odhItem, request, transformToSnowpark, 'features'),
    transformToSnowparkMultimediaDescriptions: (odhItem, request) => transformRelationshipToMany(odhItem, request, transformToSnowpark, 'multimediaDescriptions'),

    transformToCategoryCollection,
    transformToCategoryObject,
    transformToCategoryChildren: (contextCategory, request) => transformToCategoryRelationshipToMany(contextCategory, request, 'children'),
    transformToCategoryMultimediaDescriptions: (contextCategory, request) => transformToCategoryRelationshipToMany(contextCategory, request, 'multimediaDescriptions'),
    transformToCategoryParents: (contextCategory, request) => transformToCategoryRelationshipToMany(contextCategory, request, 'parents'),

    transformToFeatureCollection,
    transformToFeatureObject,
    transformToFeatureChildren: (contextFeature, request) => transformToFeatureRelationshipToMany(contextFeature, request, 'children'),
    transformToFeatureMultimediaDescriptions: (contextFeature, request) => transformToFeatureRelationshipToMany(contextFeature, request, 'multimediaDescriptions'),
    transformToFeatureParents: (contextFeature, request) => transformToFeatureRelationshipToMany(contextFeature, request, 'parents'),
}