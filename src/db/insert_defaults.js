...
function insertDefaultCategories() {
  const insertCategoriesResources = `INSERT INTO resources
    ...
    VALUES
      ('schema:BusinessEvent', 'categories', 'http://tourism.opendatahub.com/'),
      ('schema:ChildrensEvent', 'categories', 'http://tourism.opendatahub.com/'),
      ('schema:ComedyEvent', 'categories', 'http://tourism.opendatahub.com/'),
      ('schema:CourseInstance', 'categories', 'http://tourism.opendatahub.com/'),
      ('schema:DanceEvent', 'categories', 'http://tourism.opendatahub.com/'),
      ('schema:DeliveryEvent', 'categories', 'http://tourism.opendatahub.com/'),
      ('schema:EducationEvent', 'categories', 'http://tourism.opendatahub.com/'),
      ('schema:EventSeries', 'categories', 'http://tourism.opendatahub.com/'),
      ('schema:ExhibitionEvent', 'categories', 'http://tourism.opendatahub.com/'),
      ('schema:Festival', 'categories', 'http://tourism.opendatahub.com/'),
      ('schema:FoodEvent', 'categories', 'http://tourism.opendatahub.com/'),
      ('schema:Hackathon', 'categories', 'http://tourism.opendatahub.com/'),
      ('schema:LiteraryEvent', 'categories', 'http://tourism.opendatahub.com/'),
      ('schema:MusicEvent', 'categories', 'http://tourism.opendatahub.com/'),
      ('schema:PublicationEvent', 'categories', 'http://tourism.opendatahub.com/'),
      ('schema:SaleEvent', 'categories', 'http://tourism.opendatahub.com/'),
      ('schema:ScreeningEvent', 'categories', 'http://tourism.opendatahub.com/'),
      ('schema:SocialEvent', 'categories', 'http://tourism.opendatahub.com/'),
      ('schema:SportsEvent', 'categories', 'http://tourism.opendatahub.com/'),
      ('schema:TheaterEvent', 'categories', 'http://tourism.opendatahub.com/'),
      ('schema:VisualArtsEvent', 'categories', 'http://tourism.opendatahub.com/'),
      ('alpinebits:inPersonEvent', 'categories', 'http://tourism.opendatahub.com/'),
      ('alpinebits:virtualEvent', 'categories', 'http://tourism.opendatahub.com/'),
      ('alpinebits:hybridEvent', 'categories', 'http://tourism.opendatahub.com/'),
      ('alpinebits:person', 'categories', 'http://tourism.opendatahub.com/'),
      ('alpinebits:organization', 'categories', 'http://tourism.opendatahub.com/'),
      ('alpinebits:standard-ski-slope', 'categories', 'http://tourism.opendatahub.com/'),
      ('alpinebits:sledge-slope', 'categories', 'http://tourism.opendatahub.com/'),
      ('alpinebits:cross-country', 'categories', 'http://tourism.opendatahub.com/'),
      ('alpinebits:chairlift', 'categories', 'http://tourism.opendatahub.com/'),
      ('alpinebits:gondola', 'categories', 'http://tourism.opendatahub.com/'),
      ('alpinebits:skilift', 'categories', 'http://tourism.opendatahub.com/'),
      ('alpinebits:cablecar', 'categories', 'http://tourism.opendatahub.com/'),
      ('alpinebits:funicular', 'categories', 'http://tourism.opendatahub.com/'),
      ('alpinebits:magic-carpet', 'categories', 'http://tourism.opendatahub.com/'),
      ('alpinebits:skibus', 'categories', 'http://tourism.opendatahub.com/'),
      ('alpinebits:train', 'categories', 'http://tourism.opendatahub.com/')
