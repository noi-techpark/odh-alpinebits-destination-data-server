...
module.exports = {
  ...
  getLifts: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      true,
      Connector.fetchOdhLifts,
      responseTransform.transformToLiftCollection,
      Connector.simpleValidate,
      schema
    ),
  getLiftById: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      false,
      Connector.fetchOdhLifts,
  ...
  getLiftCategories: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      true,
      Connector.fetchOdhLifts,
  ...
  getLiftConnections: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      true,
      Connector.fetchOdhLifts,
  ...
  getLiftMultimediaDescriptions: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      true,
      Connector.fetchOdhLifts,
  ...
  getSkiSlopes: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      true,
      Connector.fetchOdhSkiSlopes,
      responseTransform.transformToSkiSlopeCollection,
      Connector.simpleValidate,
      schema
    ),
  getSkiSlopeById: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      false,
      Connector.fetchOdhSkiSlopes,
  ...
  getSkiSlopeCategories: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      true,
      Connector.fetchOdhSkiSlopes,
  ...
  getSkiSlopeConnections: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      true,
      Connector.fetchOdhSkiSlopes,
  ...
  getSkiSlopeMultimediaDescriptions: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      true,
      Connector.fetchOdhSkiSlopes,
  ...
  getSnowparks: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      true,
      Connector.fetchOdhSnowparks,
      responseTransform.transformToSnowparkCollection,
      Connector.simpleValidate,
      schema
    ),
  getSnowparkById: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      false,
      Connector.fetchOdhSnowparks,
  ...
  getSnowparkCategories: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      true,
      Connector.fetchOdhSnowparks,
  ...
  getSnowparkConnections: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      true,
      Connector.fetchOdhSnowparks,
  ...
  getSnowparkFeatures: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      true,
      Connector.fetchOdhSnowparks,
  ...
  getSnowparkMultimediaDescriptions: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      true,
      Connector.fetchOdhSnowparks,
  ...
  getCategories: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      true,
      Connector.fetchCategories,
      responseTransform.transformToCategoryCollection,
      Connector.simpleValidate,
      schema
    ),
  getCategoryById: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      false,
      Connector.fetchCategories,
  ...
  getCategoryChildren: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      true,
      Connector.fetchCategories,
  ...
  getCategoryMultimediaDescriptions: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      true,
      Connector.fetchCategories,
  ...
  getCategoryParents: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      true,
      Connector.fetchCategories,
  ...
  getFeatures: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      true,
      Connector.fetchFeatures,
      responseTransform.transformToFeatureCollection,
      Connector.simpleValidate,
      schema
    ),
  getFeatureById: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      false,
      Connector.fetchFeatures,
  ...
  getFeatureChildren: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      true,
      Connector.fetchFeatures,
  ...
  getFeatureMultimediaDescriptions: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      true,
      Connector.fetchFeatures,
  ...
  getFeatureParents: (request, schema) =>
    Connector.handleSimpleRequest(
      request,
      true,
      Connector.fetchFeatures,
